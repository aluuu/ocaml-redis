...
(* OASIS_START *)
(* DO NOT EDIT (digest: 50c4ce5c3d680565d3c8f8eda4b850f7) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["S"; "Utils"; "Client"; "Cache"; "Mutex"];
                      lib_pack = true;
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build the Lwt client";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src_sync";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "redis"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules = ["Redis_sync"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "redis";
                      lib_findlib_name = Some "sync";
                      lib_findlib_containers = []
                   });
               Library
                 ({
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build the examples";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Executable
                 ({
                     cs_name = "redis_examples";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "redis";
                           InternalLibrary "redis_sync";
                           InternalLibrary "redis_lwt";
                           FindlibPackage ("lwt.unix", None);
                           FindlibPackage ("lwt", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_sync.ml"});
               Executable
                 ({
                     cs_name = "test_lwt";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_lwt.ml"});
               Test
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for ocaml-redis";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\172\180ET\0143\011\236\218^\203x\173{\217\148";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
